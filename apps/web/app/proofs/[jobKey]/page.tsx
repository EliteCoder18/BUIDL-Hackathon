...
export default function ProofExplorerPage({ params }: { params: { jobKey: string } }) {
  ...
  <TechnicalPanel eyebrow="VERIFICATION PIPELINE" title="Source → proof → destination"><ProofRail stages={stages} /></TechnicalPanel>
  {proof && <div className="proof-detail-grid"><TechnicalPanel eyebrow="SOURCE CHAIN" title="Ethereum Sepolia"><dl className="technical-dl"><div><dt>TRANSACTION</dt><dd><code>{proof.sourceTxHash}</code></dd></div><div><dt>BLOCK</dt><dd>{proof.sourceBlockNumber}</dd></div><div><dt>OUTCOME</dt><dd>{proof.outcome.toUpperCase()}</dd></div></dl></TechnicalPanel><TechnicalPanel eyebrow="DESTINATION CHAIN" title="Creditcoin CC3"><dl className="technical-dl"><div><dt>TRANSACTION</dt><dd><code>{proof.creditcoinTxHash}</code></dd></div><div><dt>BLOCK</dt><dd>{proof.creditcoinBlockNumber}</dd></div><div><dt>TRANSPORT</dt><dd>{proof.proofSource}</dd></div></dl></TechnicalPanel></div>}
